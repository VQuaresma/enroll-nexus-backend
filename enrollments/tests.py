...
class EnrollmentTest(TestCase):
    def setUp(self):
        ...
        # Se você definiu o nome da rota no urls.py, pode usar: reverse('enrollment-submit')
        self.url = "/api/enrollments/submit/" 

    def test_submit_enrollment_success(self):
        # Dados completos incluindo as novas implementações (Nome Social e Tipo de Programa)
        data = {
            "program_level": "MESTRADO",  # Adicionado conforme o rádio do front
            "full_name": "Vitor Quaresma Da Silva",
            "social_name": "Vitor Silva", # Adicionado (opcional)
            "cpf": "06703385246",
        ...
        # Log de erro detalhado para facilitar o debug no NEB
